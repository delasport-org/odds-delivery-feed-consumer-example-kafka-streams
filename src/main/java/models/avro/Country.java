...
public class Country extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3383565742482300784L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Country\",\"namespace\":\"models.avro\",\"fields\":[{\"name\":\"id\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"title\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   */
  public Country(CharSequence id, CharSequence title) {
    this.id = id;
    this.title = title;
  }
   ...
   */
  public static models.avro.Country.Builder newBuilder() {
    return new models.avro.Country.Builder();
  }
   ...
   * @return A new Country RecordBuilder
   */
  public static models.avro.Country.Builder newBuilder(models.avro.Country.Builder other) {
    if (other == null) {
      return new models.avro.Country.Builder();
    } else {
      return new models.avro.Country.Builder(other);
    }
  }
   ...
   * @return A new Country RecordBuilder
   */
  public static models.avro.Country.Builder newBuilder(models.avro.Country other) {
    if (other == null) {
      return new models.avro.Country.Builder();
    } else {
      return new models.avro.Country.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Country>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.avro.Country.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.avro.Country other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Country.Builder setId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Country.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Country.Builder setTitle(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Country.Builder clearTitle() {
      title = null;
