...
public class Origin extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6507792895389586975L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Origin\",\"namespace\":\"models.avro\",\"fields\":[{\"name\":\"stream\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"type\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"environment\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"version\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<Origin> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<Origin> DECODER =
   ...
   */
  public static BinaryMessageDecoder<Origin> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this Origin to a ByteBuffer.
  ...
  /**
   * Deserializes a Origin from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a Origin instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static Origin fromByteBuffer(
   ...
   */
  public Origin(CharSequence stream, CharSequence type, CharSequence environment, CharSequence version) {
    this.stream = stream;
    this.type = type;
   ...
   * @return A new Origin RecordBuilder
   */
  public static models.avro.Origin.Builder newBuilder() {
    return new models.avro.Origin.Builder();
  }
   ...
   * @return A new Origin RecordBuilder
   */
  public static models.avro.Origin.Builder newBuilder(models.avro.Origin.Builder other) {
    if (other == null) {
      return new models.avro.Origin.Builder();
    } else {
      return new models.avro.Origin.Builder(other);
    }
  }
   ...
   * @return A new Origin RecordBuilder
   */
  public static models.avro.Origin.Builder newBuilder(models.avro.Origin other) {
    if (other == null) {
      return new models.avro.Origin.Builder();
    } else {
      return new models.avro.Origin.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Origin>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.avro.Origin.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.avro.Origin other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.stream)) {
        this.stream = data().deepCopy(fields()[0].schema(), other.stream);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Origin.Builder setStream(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Origin.Builder clearStream() {
      stream = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Origin.Builder setType(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Origin.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Origin.Builder setEnvironment(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Origin.Builder clearEnvironment() {
      environment = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Origin.Builder setVersion(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Origin.Builder clearVersion() {
      version = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<Origin>
    WRITER$ = (org.apache.avro.io.DatumWriter<Origin>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<Origin>
    READER$ = (org.apache.avro.io.DatumReader<Origin>)MODEL$.createDatumReader(SCHEMA$);
