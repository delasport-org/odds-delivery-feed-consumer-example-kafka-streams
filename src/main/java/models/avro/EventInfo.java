...
public class EventInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private models.avro.LiveGamePeriod liveGamePeriod;
  ...
  private models.avro.Teams teams;
   ...
   */
  public EventInfo(CharSequence id, CharSequence state, CharSequence status, models.avro.LiveGamePeriod liveGamePeriod, Integer liveMinute, Integer marketsCount, CharSequence startDate, CharSequence timeRange, models.avro.Sport sport, models.avro.Country country, models.avro.League league, models.avro.Teams teams) {
    this.id = id;
    this.state = state;
    this.status = status;
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: liveGamePeriod = (models.avro.LiveGamePeriod)value$; break;
    ...
    case 8: sport = (models.avro.Sport)value$; break;
    case 9: country = (models.avro.Country)value$; break;
    case 10: league = (models.avro.League)value$; break;
    case 11: teams = (models.avro.Teams)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public models.avro.LiveGamePeriod getLiveGamePeriod() {
   ...
   * @param value the value to set.
   */
  public void setLiveGamePeriod(models.avro.LiveGamePeriod value) {
   ...
   */
  public models.avro.Teams getTeams() {
    return teams;
  }
   ...
   * @param value the value to set.
   */
  public void setTeams(models.avro.Teams value) {
    this.teams = value;
  }
   ...
   */
  public static models.avro.EventInfo.Builder newBuilder() {
    return new models.avro.EventInfo.Builder();
  }
   ...
   * @return A new EventInfo RecordBuilder
   */
  public static models.avro.EventInfo.Builder newBuilder(models.avro.EventInfo.Builder other) {
    if (other == null) {
      return new models.avro.EventInfo.Builder();
    } else {
      return new models.avro.EventInfo.Builder(other);
    }
  }
   ...
   * @return A new EventInfo RecordBuilder
   */
  public static models.avro.EventInfo.Builder newBuilder(models.avro.EventInfo other) {
    if (other == null) {
      return new models.avro.EventInfo.Builder();
    } else {
      return new models.avro.EventInfo.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventInfo>
    ...
    private CharSequence status;
    private models.avro.LiveGamePeriod liveGamePeriod;
    private models.avro.LiveGamePeriod.Builder liveGamePeriodBuilder;
    private Integer liveMinute;
    private Integer marketsCount;
    private CharSequence startDate;
    private CharSequence timeRange;
    ...
    private models.avro.Teams teams;
    private models.avro.Teams.Builder teamsBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.avro.EventInfo.Builder other) {
      super(other);
      ...
      if (other.hasLiveGamePeriodBuilder()) {
        this.liveGamePeriodBuilder = models.avro.LiveGamePeriod.newBuilder(other.getLiveGamePeriodBuilder());
      }
      ...
      if (other.hasTeamsBuilder()) {
        this.teamsBuilder = models.avro.Teams.newBuilder(other.getTeamsBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.avro.EventInfo other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder setId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder setState(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder setStatus(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder setLiveGamePeriod(models.avro.LiveGamePeriod value) {
     ...
     * @return This builder.
     */
    public models.avro.LiveGamePeriod.Builder getLiveGamePeriodBuilder() {
      if (liveGamePeriodBuilder == null) {
        if (hasLiveGamePeriod()) {
          setLiveGamePeriodBuilder(models.avro.LiveGamePeriod.newBuilder(liveGamePeriod));
        } else {
          setLiveGamePeriodBuilder(models.avro.LiveGamePeriod.newBuilder());
        }
      }
    ...
    public models.avro.EventInfo.Builder setLiveGamePeriodBuilder(models.avro.LiveGamePeriod.Builder value) {
      clearLiveGamePeriod();
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder clearLiveGamePeriod() {
      liveGamePeriod = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder setLiveMinute(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder clearLiveMinute() {
      liveMinute = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder setMarketsCount(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder clearMarketsCount() {
      marketsCount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder setStartDate(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder clearStartDate() {
      startDate = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder setTimeRange(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder clearTimeRange() {
      timeRange = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder setSport(models.avro.Sport value) {
    ...
    public models.avro.EventInfo.Builder setSportBuilder(models.avro.Sport.Builder value) {
      clearSport();
      sportBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder clearSport() {
      sport = null;
      sportBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder setCountry(models.avro.Country value) {
    ...
    public models.avro.EventInfo.Builder setCountryBuilder(models.avro.Country.Builder value) {
      clearCountry();
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder clearCountry() {
      country = null;
      countryBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder setLeague(models.avro.League value) {
    ...
    public models.avro.EventInfo.Builder setLeagueBuilder(models.avro.League.Builder value) {
      clearLeague();
      leagueBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder clearLeague() {
      league = null;
      leagueBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder setTeams(models.avro.Teams value) {
     ...
     * @return This builder.
     */
    public models.avro.Teams.Builder getTeamsBuilder() {
      if (teamsBuilder == null) {
        if (hasTeams()) {
          setTeamsBuilder(models.avro.Teams.newBuilder(teams));
        } else {
          setTeamsBuilder(models.avro.Teams.newBuilder());
        }
      }
      return teamsBuilder;
    }
    ...
    public models.avro.EventInfo.Builder setTeamsBuilder(models.avro.Teams.Builder value) {
      clearTeams();
      teamsBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.EventInfo.Builder clearTeams() {
      teams = null;
      teamsBuilder = null;
    ...
    public EventInfo build() {
      try {
        ...
        if (liveGamePeriodBuilder != null) {
          ...
          record.liveGamePeriod = fieldSetFlags()[3] ? this.liveGamePeriod : (models.avro.LiveGamePeriod) defaultValue(fields()[3]);
        }
        ...
        if (sportBuilder != null) {
          ...
          record.sport = fieldSetFlags()[8] ? this.sport : (models.avro.Sport) defaultValue(fields()[8]);
        }
        if (countryBuilder != null) {
          try {
          ...
          record.country = fieldSetFlags()[9] ? this.country : (models.avro.Country) defaultValue(fields()[9]);
        }
        if (leagueBuilder != null) {
          try {
        ...
        if (teamsBuilder != null) {
          ...
          record.teams = fieldSetFlags()[11] ? this.teams : (models.avro.Teams) defaultValue(fields()[11]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.liveGamePeriod == null) {
          this.liveGamePeriod = new models.avro.LiveGamePeriod();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.teams == null) {
          this.teams = new models.avro.Teams();
        }
