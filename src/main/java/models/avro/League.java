...
public class League extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static models.avro.League.Builder newBuilder() {
    return new models.avro.League.Builder();
  }
   ...
   * @return A new League RecordBuilder
   */
  public static models.avro.League.Builder newBuilder(models.avro.League.Builder other) {
    if (other == null) {
      return new models.avro.League.Builder();
    } else {
      return new models.avro.League.Builder(other);
    }
  }
   ...
   * @return A new League RecordBuilder
   */
  public static models.avro.League.Builder newBuilder(models.avro.League other) {
    if (other == null) {
      return new models.avro.League.Builder();
    } else {
      return new models.avro.League.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<League>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.avro.League.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.avro.League other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.League.Builder setId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.League.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.League.Builder setTitle(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.League.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.League.Builder setFormat(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.League.Builder clearFormat() {
      format = null;
