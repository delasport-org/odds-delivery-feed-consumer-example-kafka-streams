...
public class Score extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static models.avro.Score.Builder newBuilder() {
    return new models.avro.Score.Builder();
  }
   ...
   * @return A new Score RecordBuilder
   */
  public static models.avro.Score.Builder newBuilder(models.avro.Score.Builder other) {
    if (other == null) {
      return new models.avro.Score.Builder();
    } else {
      return new models.avro.Score.Builder(other);
    }
  }
   ...
   * @return A new Score RecordBuilder
   */
  public static models.avro.Score.Builder newBuilder(models.avro.Score other) {
    if (other == null) {
      return new models.avro.Score.Builder();
    } else {
      return new models.avro.Score.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Score>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.avro.Score.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.avro.Score other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.homeTeam)) {
        this.homeTeam = data().deepCopy(fields()[0].schema(), other.homeTeam);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Score.Builder setHomeTeam(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Score.Builder clearHomeTeam() {
      homeTeam = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Score.Builder setAwayTeam(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Score.Builder clearAwayTeam() {
      awayTeam = null;
