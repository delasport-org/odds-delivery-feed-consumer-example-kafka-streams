...
public class Team extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -38163795009889329L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Team\",\"namespace\":\"models.avro\",\"fields\":[{\"name\":\"id\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"name\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"color\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   */
  public Team(CharSequence id, CharSequence name, CharSequence color) {
    this.id = id;
    this.name = name;
    this.color = color;
  }
  ...
  public void put(int field$, Object value$) {
    ...
    case 2: color = (CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static models.avro.Team.Builder newBuilder() {
    return new models.avro.Team.Builder();
  }
   ...
   * @return A new Team RecordBuilder
   */
  public static models.avro.Team.Builder newBuilder(models.avro.Team.Builder other) {
    if (other == null) {
      return new models.avro.Team.Builder();
    } else {
      return new models.avro.Team.Builder(other);
    }
  }
   ...
   * @return A new Team RecordBuilder
   */
  public static models.avro.Team.Builder newBuilder(models.avro.Team other) {
    if (other == null) {
      return new models.avro.Team.Builder();
    } else {
      return new models.avro.Team.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Team>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.avro.Team.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.avro.Team other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Team.Builder setId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Team.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Team.Builder setName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Team.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Team.Builder setColor(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Team.Builder clearColor() {
      color = null;
    ...
    public Team build() {
      try {
        ...
        record.color = fieldSetFlags()[2] ? this.color : (CharSequence) defaultValue(fields()[2]);
        return record;
