...
public class EventSportsStreamMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8252570486637057347L;
  ...
  private java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,models.avro.Score>> typedScores;
   ...
   */
  public EventSportsStreamMessage(models.avro.Origin origin, java.lang.CharSequence id, models.avro.EventInfo eventInfo, java.util.List<models.avro.LiveScores> liveScores, java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,models.avro.Score>> typedScores, java.lang.CharSequence timestamp, java.lang.CharSequence additionalInfo) {
    this.origin = origin;
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
      ...
      case 4: typedScores = (java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,models.avro.Score>>)value$; break;
      case 5: timestamp = (java.lang.CharSequence)value$; break;
      case 6: additionalInfo = (java.lang.CharSequence)value$; break;
      default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,models.avro.Score>> getTypedScores() {
    return typedScores;
  }
   ...
   * @param value the value to set.
   */
  public void setTypedScores(java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,models.avro.Score>> value) {
   ...
   * @param value the value to set.
   */
  public void setAdditionalInfo(java.lang.CharSequence value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventSportsStreamMessage>
    ...
    private Builder(models.avro.EventSportsStreamMessage.Builder other) {
      ...
      if (isValidValue(fields()[6], other.additionalInfo)) {
        this.additionalInfo = data().deepCopy(fields()[6].schema(), other.additionalInfo);
     ...
     * @return This builder.
     */
    public models.avro.EventSportsStreamMessage.Builder setId(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public models.avro.EventSportsStreamMessage.Builder setTypedScores(java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,models.avro.Score>> value) {
     ...
     * @return This builder.
     */
    public models.avro.EventSportsStreamMessage.Builder setTimestamp(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public models.avro.EventSportsStreamMessage.Builder setAdditionalInfo(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public models.avro.EventSportsStreamMessage.Builder clearAdditionalInfo() {
      additionalInfo = null;
    ...
    public EventSportsStreamMessage build() {
      try {
        ...
        record.typedScores = fieldSetFlags()[4] ? this.typedScores : (java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,models.avro.Score>>) defaultValue(fields()[4]);
        record.timestamp = fieldSetFlags()[5] ? this.timestamp : (java.lang.CharSequence) defaultValue(fields()[5]);
        record.additionalInfo = fieldSetFlags()[6] ? this.additionalInfo : (java.lang.CharSequence) defaultValue(fields()[6]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
          ...
          throws java.io.IOException
  {
    ...
    if (this.typedScores == null) {
      ...
      long actualSize1 = 0;
      for (java.util.Map.Entry<java.lang.CharSequence, java.util.Map<java.lang.CharSequence,models.avro.Score>> e1: this.typedScores.entrySet()) {
        actualSize1++;
        out.startItem();
        out.writeString(e1.getKey());
        java.util.Map<java.lang.CharSequence,models.avro.Score> v1 = e1.getValue();
        long size2 = v1.size();
        out.writeMapStart();
        out.setItemCount(size2);
        long actualSize2 = 0;
        for (java.util.Map.Entry<java.lang.CharSequence, models.avro.Score> e2: v1.entrySet()) {
          actualSize2++;
          out.startItem();
          ...
          throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        java.util.Map<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,models.avro.Score>> m1 = this.typedScores; // Need fresh name due to limitation of macro system
        if (m1 == null) {
          m1 = new java.util.HashMap<java.lang.CharSequence,java.util.Map<java.lang.CharSequence,models.avro.Score>>((int)size1);
          this.typedScores = m1;
        } else m1.clear();
        for ( ; 0 < size1; size1 = in.mapNext()) {
          for ( ; size1 != 0; size1--) {
            ...
            java.util.Map<java.lang.CharSequence,models.avro.Score> v1 = null;
            long size2 = in.readMapStart();
            java.util.Map<java.lang.CharSequence,models.avro.Score> m2 = v1; // Need fresh name due to limitation of macro system
            if (m2 == null) {
              m2 = new java.util.HashMap<java.lang.CharSequence,models.avro.Score>((int)size2);
              v1 = m2;
            } else m2.clear();
      ...
      if (in.readIndex() != 1) {
        ...
        this.additionalInfo = in.readString(this.additionalInfo instanceof Utf8 ? (Utf8)this.additionalInfo : null);
      }
