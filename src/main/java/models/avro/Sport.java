...
public class Sport extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static models.avro.Sport.Builder newBuilder() {
    return new models.avro.Sport.Builder();
  }
   ...
   * @return A new Sport RecordBuilder
   */
  public static models.avro.Sport.Builder newBuilder(models.avro.Sport.Builder other) {
    if (other == null) {
      return new models.avro.Sport.Builder();
    } else {
      return new models.avro.Sport.Builder(other);
    }
  }
   ...
   * @return A new Sport RecordBuilder
   */
  public static models.avro.Sport.Builder newBuilder(models.avro.Sport other) {
    if (other == null) {
      return new models.avro.Sport.Builder();
    } else {
      return new models.avro.Sport.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Sport>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.avro.Sport.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.avro.Sport other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Sport.Builder setId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Sport.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Sport.Builder setTitle(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Sport.Builder clearTitle() {
      title = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Sport.Builder setKey(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.Sport.Builder clearKey() {
      key = null;
