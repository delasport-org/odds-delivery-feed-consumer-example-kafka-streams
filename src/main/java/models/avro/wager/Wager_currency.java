...
public class Wager_currency extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static models.avro.wager.Wager_currency.Builder newBuilder() {
    return new models.avro.wager.Wager_currency.Builder();
  }
   ...
   * @return A new Wager_currency RecordBuilder
   */
  public static models.avro.wager.Wager_currency.Builder newBuilder(models.avro.wager.Wager_currency.Builder other) {
    if (other == null) {
      return new models.avro.wager.Wager_currency.Builder();
    } else {
      return new models.avro.wager.Wager_currency.Builder(other);
    }
  }
   ...
   * @return A new Wager_currency RecordBuilder
   */
  public static models.avro.wager.Wager_currency.Builder newBuilder(models.avro.wager.Wager_currency other) {
    if (other == null) {
      return new models.avro.wager.Wager_currency.Builder();
    } else {
      return new models.avro.wager.Wager_currency.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Wager_currency>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.avro.wager.Wager_currency.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.avro.wager.Wager_currency other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_currency.Builder setId(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_currency.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_currency.Builder setName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_currency.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_currency.Builder setExchangeRate(Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_currency.Builder clearExchangeRate() {
      exchangeRate = null;
