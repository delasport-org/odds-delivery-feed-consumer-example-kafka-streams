...
public class Wager_member extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static models.avro.wager.Wager_member.Builder newBuilder() {
    return new models.avro.wager.Wager_member.Builder();
  }
   ...
   * @return A new Wager_member RecordBuilder
   */
  public static models.avro.wager.Wager_member.Builder newBuilder(models.avro.wager.Wager_member.Builder other) {
    if (other == null) {
      return new models.avro.wager.Wager_member.Builder();
    } else {
      return new models.avro.wager.Wager_member.Builder(other);
    }
  }
   ...
   * @return A new Wager_member RecordBuilder
   */
  public static models.avro.wager.Wager_member.Builder newBuilder(models.avro.wager.Wager_member other) {
    if (other == null) {
      return new models.avro.wager.Wager_member.Builder();
    } else {
      return new models.avro.wager.Wager_member.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Wager_member>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.avro.wager.Wager_member.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.avro.wager.Wager_member other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_member.Builder setId(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_member.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_member.Builder setUsername(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_member.Builder clearUsername() {
      username = null;
