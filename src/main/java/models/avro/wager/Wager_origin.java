...
public class Wager_origin extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static models.avro.wager.Wager_origin.Builder newBuilder() {
    return new models.avro.wager.Wager_origin.Builder();
  }
   ...
   * @return A new Wager_origin RecordBuilder
   */
  public static models.avro.wager.Wager_origin.Builder newBuilder(models.avro.wager.Wager_origin.Builder other) {
    if (other == null) {
      return new models.avro.wager.Wager_origin.Builder();
    } else {
      return new models.avro.wager.Wager_origin.Builder(other);
    }
  }
   ...
   * @return A new Wager_origin RecordBuilder
   */
  public static models.avro.wager.Wager_origin.Builder newBuilder(models.avro.wager.Wager_origin other) {
    if (other == null) {
      return new models.avro.wager.Wager_origin.Builder();
    } else {
      return new models.avro.wager.Wager_origin.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Wager_origin>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.avro.wager.Wager_origin.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.avro.wager.Wager_origin other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.stream)) {
        this.stream = data().deepCopy(fields()[0].schema(), other.stream);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_origin.Builder setStream(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_origin.Builder clearStream() {
      stream = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_origin.Builder setType(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_origin.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_origin.Builder setEnvironment(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_origin.Builder clearEnvironment() {
      environment = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_origin.Builder setVersion(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_origin.Builder clearVersion() {
      version = null;
