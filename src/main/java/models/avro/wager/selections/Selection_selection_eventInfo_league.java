...
public class Selection_selection_eventInfo_league extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static models.avro.wager.selections.Selection_selection_eventInfo_league.Builder newBuilder() {
    return new models.avro.wager.selections.Selection_selection_eventInfo_league.Builder();
  }
   ...
   * @return A new Selection_selection_eventInfo_league RecordBuilder
   */
  public static models.avro.wager.selections.Selection_selection_eventInfo_league.Builder newBuilder(models.avro.wager.selections.Selection_selection_eventInfo_league.Builder other) {
    if (other == null) {
      return new models.avro.wager.selections.Selection_selection_eventInfo_league.Builder();
    } else {
      return new models.avro.wager.selections.Selection_selection_eventInfo_league.Builder(other);
    }
  }
   ...
   * @return A new Selection_selection_eventInfo_league RecordBuilder
   */
  public static models.avro.wager.selections.Selection_selection_eventInfo_league.Builder newBuilder(models.avro.wager.selections.Selection_selection_eventInfo_league other) {
    if (other == null) {
      return new models.avro.wager.selections.Selection_selection_eventInfo_league.Builder();
    } else {
      return new models.avro.wager.selections.Selection_selection_eventInfo_league.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Selection_selection_eventInfo_league>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.avro.wager.selections.Selection_selection_eventInfo_league.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.avro.wager.selections.Selection_selection_eventInfo_league other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.selections.Selection_selection_eventInfo_league.Builder setId(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.selections.Selection_selection_eventInfo_league.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.selections.Selection_selection_eventInfo_league.Builder setName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.selections.Selection_selection_eventInfo_league.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.selections.Selection_selection_eventInfo_league.Builder setFormat(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.selections.Selection_selection_eventInfo_league.Builder clearFormat() {
      format = null;
