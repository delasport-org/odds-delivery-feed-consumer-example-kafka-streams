...
public class Wager_stake extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private models.avro.wager.Wager_stake_wallet wallet;
   ...
   */
  public Wager_stake(Double amount, models.avro.wager.Wager_stake_wallet wallet) {
    this.amount = amount;
    this.wallet = wallet;
  }
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: wallet = (models.avro.wager.Wager_stake_wallet)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public models.avro.wager.Wager_stake_wallet getWallet() {
    return wallet;
  }
   ...
   * @param value the value to set.
   */
  public void setWallet(models.avro.wager.Wager_stake_wallet value) {
    this.wallet = value;
  }
   ...
   */
  public static models.avro.wager.Wager_stake.Builder newBuilder() {
    return new models.avro.wager.Wager_stake.Builder();
  }
   ...
   * @return A new Wager_stake RecordBuilder
   */
  public static models.avro.wager.Wager_stake.Builder newBuilder(models.avro.wager.Wager_stake.Builder other) {
    if (other == null) {
      return new models.avro.wager.Wager_stake.Builder();
    } else {
      return new models.avro.wager.Wager_stake.Builder(other);
    }
  }
   ...
   * @return A new Wager_stake RecordBuilder
   */
  public static models.avro.wager.Wager_stake.Builder newBuilder(models.avro.wager.Wager_stake other) {
    if (other == null) {
      return new models.avro.wager.Wager_stake.Builder();
    } else {
      return new models.avro.wager.Wager_stake.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Wager_stake>
    ...
    private Double amount;
    private models.avro.wager.Wager_stake_wallet wallet;
    private models.avro.wager.Wager_stake_wallet.Builder walletBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(models.avro.wager.Wager_stake.Builder other) {
      super(other);
      ...
      if (other.hasWalletBuilder()) {
        this.walletBuilder = models.avro.wager.Wager_stake_wallet.newBuilder(other.getWalletBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(models.avro.wager.Wager_stake other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.amount)) {
        this.amount = data().deepCopy(fields()[0].schema(), other.amount);
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_stake.Builder setAmount(Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_stake.Builder clearAmount() {
      amount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_stake.Builder setWallet(models.avro.wager.Wager_stake_wallet value) {
     ...
     * @return This builder.
     */
    public models.avro.wager.Wager_stake_wallet.Builder getWalletBuilder() {
      if (walletBuilder == null) {
        if (hasWallet()) {
          setWalletBuilder(models.avro.wager.Wager_stake_wallet.newBuilder(wallet));
        } else {
          setWalletBuilder(models.avro.wager.Wager_stake_wallet.newBuilder());
        }
      }
    ...
    public models.avro.wager.Wager_stake.Builder setWalletBuilder(models.avro.wager.Wager_stake_wallet.Builder value) {
      clearWallet();
      walletBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public models.avro.wager.Wager_stake.Builder clearWallet() {
      wallet = null;
      walletBuilder = null;
    ...
    public Wager_stake build() {
      try {
        ...
        if (walletBuilder != null) {
          ...
          record.wallet = fieldSetFlags()[1] ? this.wallet : (models.avro.wager.Wager_stake_wallet) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.wallet == null) {
          this.wallet = new models.avro.wager.Wager_stake_wallet();
        }
