...
public class LiveScores extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public LiveScores(LineEntity lineEntity, GamePeriod gamePeriod, Integer home, Integer away) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: lineEntity = (LineEntity)value$; break;
    case 1: gamePeriod = (GamePeriod)value$; break;
   ...
   */
  public static LiveScores.Builder newBuilder() {
    return new LiveScores.Builder();
  }
   ...
   * @return A new LiveScores RecordBuilder
   */
  public static LiveScores.Builder newBuilder(LiveScores.Builder other) {
    if (other == null) {
      return new LiveScores.Builder();
    } else {
      return new LiveScores.Builder(other);
    }
  }
   ...
   * @return A new LiveScores RecordBuilder
   */
  public static LiveScores.Builder newBuilder(LiveScores other) {
    if (other == null) {
      return new LiveScores.Builder();
    } else {
      return new LiveScores.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LiveScores>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(LiveScores.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(LiveScores other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.lineEntity)) {
        this.lineEntity = data().deepCopy(fields()[0].schema(), other.lineEntity);
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScores.Builder setLineEntity(LineEntity value) {
    ...
    public LiveScores.Builder setLineEntityBuilder(LineEntity.Builder value) {
      clearLineEntity();
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScores.Builder clearLineEntity() {
      lineEntity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScores.Builder setGamePeriod(GamePeriod value) {
    ...
    public LiveScores.Builder setGamePeriodBuilder(GamePeriod.Builder value) {
      clearGamePeriod();
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScores.Builder clearGamePeriod() {
      gamePeriod = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScores.Builder setHome(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScores.Builder clearHome() {
      home = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScores.Builder setAway(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScores.Builder clearAway() {
      away = null;
    ...
    public LiveScores build() {
      try {
        ...
        if (lineEntityBuilder != null) {
          ...
          record.lineEntity = fieldSetFlags()[0] ? this.lineEntity : (LineEntity) defaultValue(fields()[0]);
        }
        if (gamePeriodBuilder != null) {
          try {
          ...
          record.gamePeriod = fieldSetFlags()[1] ? this.gamePeriod : (GamePeriod) defaultValue(fields()[1]);
        }
