...
public class LiveScore extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static LiveScore.Builder newBuilder() {
    return new LiveScore.Builder();
  }
   ...
   * @return A new LiveScore RecordBuilder
   */
  public static LiveScore.Builder newBuilder(LiveScore.Builder other) {
    if (other == null) {
      return new LiveScore.Builder();
    } else {
      return new LiveScore.Builder(other);
    }
  }
   ...
   * @return A new LiveScore RecordBuilder
   */
  public static LiveScore.Builder newBuilder(LiveScore other) {
    if (other == null) {
      return new LiveScore.Builder();
    } else {
      return new LiveScore.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LiveScore>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(LiveScore.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(LiveScore other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.lineEntityId)) {
        this.lineEntityId = data().deepCopy(fields()[0].schema(), other.lineEntityId);
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScore.Builder setLineEntityId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScore.Builder clearLineEntityId() {
      lineEntityId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScore.Builder setLineEntityName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScore.Builder clearLineEntityName() {
      lineEntityName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScore.Builder setGamePeriodId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScore.Builder clearGamePeriodId() {
      gamePeriodId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScore.Builder setGamePeriodName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScore.Builder clearGamePeriodName() {
      gamePeriodName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScore.Builder setHomeTeam(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScore.Builder clearHomeTeam() {
      homeTeam = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScore.Builder setAwayTeam(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LiveScore.Builder clearAwayTeam() {
      awayTeam = null;
