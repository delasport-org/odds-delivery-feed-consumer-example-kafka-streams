...
public class SettlementSportsStreamMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public SettlementSportsStreamMessage(Origin origin, CharSequence id, CharSequence status, EventInfo eventInfo, LineInfo lineInfo, OddOddsHistory odd, CharSequence timestamp) {
    this.origin = origin;
    this.id = id;
    this.status = status;
   ...
   */
  public static SettlementSportsStreamMessage.Builder newBuilder() {
    return new SettlementSportsStreamMessage.Builder();
  }
   ...
   * @return A new SettlementSportsStreamMessage RecordBuilder
   */
  public static SettlementSportsStreamMessage.Builder newBuilder(SettlementSportsStreamMessage.Builder other) {
    if (other == null) {
      return new SettlementSportsStreamMessage.Builder();
    } else {
      return new SettlementSportsStreamMessage.Builder(other);
    }
  }
   ...
   * @return A new SettlementSportsStreamMessage RecordBuilder
   */
  public static SettlementSportsStreamMessage.Builder newBuilder(SettlementSportsStreamMessage other) {
    if (other == null) {
      return new SettlementSportsStreamMessage.Builder();
    } else {
      return new SettlementSportsStreamMessage.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SettlementSportsStreamMessage>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(SettlementSportsStreamMessage.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(SettlementSportsStreamMessage other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.origin)) {
        this.origin = data().deepCopy(fields()[0].schema(), other.origin);
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder setOrigin(Origin value) {
    ...
    public SettlementSportsStreamMessage.Builder setOriginBuilder(Origin.Builder value) {
      clearOrigin();
      originBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder clearOrigin() {
      origin = null;
      originBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder setId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder setStatus(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder setEventInfo(EventInfo value) {
    ...
    public SettlementSportsStreamMessage.Builder setEventInfoBuilder(EventInfo.Builder value) {
      clearEventInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder clearEventInfo() {
      eventInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder setLineInfo(LineInfo value) {
    ...
    public SettlementSportsStreamMessage.Builder setLineInfoBuilder(LineInfo.Builder value) {
      clearLineInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder clearLineInfo() {
      lineInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder setOdd(OddOddsHistory value) {
    ...
    public SettlementSportsStreamMessage.Builder setOddBuilder(OddOddsHistory.Builder value) {
      clearOdd();
      oddBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder clearOdd() {
      odd = null;
      oddBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder setTimestamp(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementSportsStreamMessage.Builder clearTimestamp() {
      timestamp = null;
