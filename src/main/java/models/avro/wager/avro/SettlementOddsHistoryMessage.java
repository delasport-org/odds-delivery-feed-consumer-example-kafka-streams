...
public class SettlementOddsHistoryMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<SettlementOddsHistoryMessage> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SettlementOddsHistoryMessage> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SettlementOddsHistoryMessage> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SettlementOddsHistoryMessage to a ByteBuffer.
  ...
  /**
   * Deserializes a SettlementOddsHistoryMessage from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SettlementOddsHistoryMessage instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SettlementOddsHistoryMessage fromByteBuffer(
   ...
   */
  public SettlementOddsHistoryMessage() {}
   ...
   */
  public SettlementOddsHistoryMessage(Origin origin, CharSequence id, CharSequence status, EventInfo eventInfo, LineInfo lineInfo, OddOddsHistory odd, CharSequence timestamp, GcsPartitioner gcsPartitioner) {
    this.origin = origin;
    this.id = id;
    this.status = status;
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: eventInfo = (EventInfo)value$; break;
    case 4: lineInfo = (LineInfo)value$; break;
    case 5: odd = (OddOddsHistory)value$; break;
    case 6: timestamp = (CharSequence)value$; break;
    case 7: gcsPartitioner = (GcsPartitioner)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  /**
   * Creates a new SettlementOddsHistoryMessage RecordBuilder.
   * @return A new SettlementOddsHistoryMessage RecordBuilder
   */
  public static SettlementOddsHistoryMessage.Builder newBuilder() {
    return new SettlementOddsHistoryMessage.Builder();
  }

  /**
   * Creates a new SettlementOddsHistoryMessage RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SettlementOddsHistoryMessage RecordBuilder
   */
  public static SettlementOddsHistoryMessage.Builder newBuilder(SettlementOddsHistoryMessage.Builder other) {
    if (other == null) {
      return new SettlementOddsHistoryMessage.Builder();
    } else {
      return new SettlementOddsHistoryMessage.Builder(other);
    }
  }

  /**
   * Creates a new SettlementOddsHistoryMessage RecordBuilder by copying an existing SettlementOddsHistoryMessage instance.
   * @param other The existing instance to copy.
   * @return A new SettlementOddsHistoryMessage RecordBuilder
   */
  public static SettlementOddsHistoryMessage.Builder newBuilder(SettlementOddsHistoryMessage other) {
    if (other == null) {
      return new SettlementOddsHistoryMessage.Builder();
    } else {
      return new SettlementOddsHistoryMessage.Builder(other);
  ...
  /**
   * RecordBuilder for SettlementOddsHistoryMessage instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SettlementOddsHistoryMessage>
    implements org.apache.avro.data.RecordBuilder<SettlementOddsHistoryMessage> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(SettlementOddsHistoryMessage.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[7], other.gcsPartitioner)) {
        this.gcsPartitioner = data().deepCopy(fields()[7].schema(), other.gcsPartitioner);
    ...
    /**
     * Creates a Builder by copying an existing SettlementOddsHistoryMessage instance
     * @param other The existing instance to copy.
     */
    private Builder(SettlementOddsHistoryMessage other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.origin)) {
        this.origin = data().deepCopy(fields()[0].schema(), other.origin);
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder setOrigin(Origin value) {
    ...
    public SettlementOddsHistoryMessage.Builder setOriginBuilder(Origin.Builder value) {
      clearOrigin();
      originBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder clearOrigin() {
      origin = null;
      originBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder setId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder setStatus(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder setEventInfo(EventInfo value) {
    ...
    public SettlementOddsHistoryMessage.Builder setEventInfoBuilder(EventInfo.Builder value) {
      clearEventInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder clearEventInfo() {
      eventInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder setLineInfo(LineInfo value) {
    ...
    public SettlementOddsHistoryMessage.Builder setLineInfoBuilder(LineInfo.Builder value) {
      clearLineInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder clearLineInfo() {
      lineInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder setOdd(OddOddsHistory value) {
    ...
    public SettlementOddsHistoryMessage.Builder setOddBuilder(OddOddsHistory.Builder value) {
      clearOdd();
      oddBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder clearOdd() {
      odd = null;
      oddBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder setTimestamp(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder clearTimestamp() {
      timestamp = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder setGcsPartitioner(GcsPartitioner value) {
    ...
    public SettlementOddsHistoryMessage.Builder setGcsPartitionerBuilder(GcsPartitioner.Builder value) {
      clearGcsPartitioner();
    ...
    /**
      ...
      * @return This builder.
      */
    public SettlementOddsHistoryMessage.Builder clearGcsPartitioner() {
      gcsPartitioner = null;
    ...
    public SettlementOddsHistoryMessage build() {
      try {
        SettlementOddsHistoryMessage record = new SettlementOddsHistoryMessage();
        if (originBuilder != null) {
          try {
        ...
        if (eventInfoBuilder != null) {
          ...
          record.eventInfo = fieldSetFlags()[3] ? this.eventInfo : (EventInfo) defaultValue(fields()[3]);
        }
        if (lineInfoBuilder != null) {
          try {
          ...
          record.lineInfo = fieldSetFlags()[4] ? this.lineInfo : (LineInfo) defaultValue(fields()[4]);
        }
        if (oddBuilder != null) {
          try {
          ...
          record.odd = fieldSetFlags()[5] ? this.odd : (OddOddsHistory) defaultValue(fields()[5]);
        }
        ...
        if (gcsPartitionerBuilder != null) {
          ...
          record.gcsPartitioner = fieldSetFlags()[7] ? this.gcsPartitioner : (GcsPartitioner) defaultValue(fields()[7]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SettlementOddsHistoryMessage>
    WRITER$ = (org.apache.avro.io.DatumWriter<SettlementOddsHistoryMessage>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SettlementOddsHistoryMessage>
    READER$ = (org.apache.avro.io.DatumReader<SettlementOddsHistoryMessage>)MODEL$.createDatumReader(SCHEMA$);
