...
public class MarketSportsStreamMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private java.util.List<OddOddsHistory> odds;
   ...
   */
  public MarketSportsStreamMessage(Origin origin, CharSequence id, EventInfo eventInfo, LineInfo lineInfo, java.util.List<OddOddsHistory> odds, CharSequence timestamp) {
    this.origin = origin;
    this.id = id;
  ...
  public void put(int field$, Object value$) {
    ...
    case 4: odds = (java.util.List<OddOddsHistory>)value$; break;
   ...
   */
  public java.util.List<OddOddsHistory> getOdds() {
    return odds;
  }
   ...
   * @param value the value to set.
   */
  public void setOdds(java.util.List<OddOddsHistory> value) {
    this.odds = value;
  }
   ...
   */
  public static MarketSportsStreamMessage.Builder newBuilder() {
    return new MarketSportsStreamMessage.Builder();
  }
   ...
   * @return A new MarketSportsStreamMessage RecordBuilder
   */
  public static MarketSportsStreamMessage.Builder newBuilder(MarketSportsStreamMessage.Builder other) {
    if (other == null) {
      return new MarketSportsStreamMessage.Builder();
    } else {
      return new MarketSportsStreamMessage.Builder(other);
    }
  }
   ...
   * @return A new MarketSportsStreamMessage RecordBuilder
   */
  public static MarketSportsStreamMessage.Builder newBuilder(MarketSportsStreamMessage other) {
    if (other == null) {
      return new MarketSportsStreamMessage.Builder();
    } else {
      return new MarketSportsStreamMessage.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MarketSportsStreamMessage>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(MarketSportsStreamMessage.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(MarketSportsStreamMessage other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.origin)) {
        this.origin = data().deepCopy(fields()[0].schema(), other.origin);
    ...
    /**
      ...
      * @return This builder.
      */
    public MarketSportsStreamMessage.Builder setOrigin(Origin value) {
    ...
    public MarketSportsStreamMessage.Builder setOriginBuilder(Origin.Builder value) {
      clearOrigin();
      originBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public MarketSportsStreamMessage.Builder clearOrigin() {
      origin = null;
      originBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public MarketSportsStreamMessage.Builder setId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public MarketSportsStreamMessage.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public MarketSportsStreamMessage.Builder setEventInfo(EventInfo value) {
    ...
    public MarketSportsStreamMessage.Builder setEventInfoBuilder(EventInfo.Builder value) {
      clearEventInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public MarketSportsStreamMessage.Builder clearEventInfo() {
      eventInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public MarketSportsStreamMessage.Builder setLineInfo(LineInfo value) {
    ...
    public MarketSportsStreamMessage.Builder setLineInfoBuilder(LineInfo.Builder value) {
      clearLineInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public MarketSportsStreamMessage.Builder clearLineInfo() {
      lineInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public MarketSportsStreamMessage.Builder setOdds(java.util.List<OddOddsHistory> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public MarketSportsStreamMessage.Builder clearOdds() {
      odds = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public MarketSportsStreamMessage.Builder setTimestamp(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public MarketSportsStreamMessage.Builder clearTimestamp() {
      timestamp = null;
    ...
    public MarketSportsStreamMessage build() {
      try {
        ...
        record.odds = fieldSetFlags()[4] ? this.odds : (java.util.List<OddOddsHistory>) defaultValue(fields()[4]);
    ...
    throws java.io.IOException
  {
    ...
    if (this.odds == null) {
      ...
      long actualSize0 = 0;
      for (OddOddsHistory e0: this.odds) {
        actualSize0++;
        out.startItem();
        e0.customEncode(out);
      }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        java.util.List<OddOddsHistory> a0 = this.odds;
        if (a0 == null) {
          a0 = new SpecificData.Array<OddOddsHistory>((int)size0, SCHEMA$.getField("odds").schema().getTypes().get(1));
          this.odds = a0;
        } else a0.clear();
        SpecificData.Array<OddOddsHistory> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<OddOddsHistory>)a0 : null);
        for ( ; 0 < size0; size0 = in.arrayNext()) {
          for ( ; size0 != 0; size0--) {
            OddOddsHistory e0 = (ga0 != null ? ga0.peek() : null);
            if (e0 == null) {
              e0 = new OddOddsHistory();
            }
            e0.customDecode(in);
            a0.add(e0);
          }
