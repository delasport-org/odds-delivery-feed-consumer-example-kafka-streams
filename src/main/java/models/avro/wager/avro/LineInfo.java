...
public class LineInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public LineInfo(CharSequence id, Integer index, CharSequence updatedAt, MarketType marketType, LineEntity lineEntity, GamePeriod gamePeriod, Boolean isValid, Double spread) {
    this.id = id;
    this.index = index;
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: marketType = (MarketType)value$; break;
    case 4: lineEntity = (LineEntity)value$; break;
    case 5: gamePeriod = (GamePeriod)value$; break;
   ...
   * @param value the value to set.
   */
  public void setLineEntity(LineEntity value) {
   ...
   * @param value the value to set.
   */
  public void setGamePeriod(GamePeriod value) {
   ...
   */
  public static LineInfo.Builder newBuilder() {
   ...
   * @return A new LineInfo RecordBuilder
   */
  public static LineInfo.Builder newBuilder(LineInfo.Builder other) {
    if (other == null) {
      return new LineInfo.Builder();
    } else {
      return new LineInfo.Builder(other);
    }
  }
   ...
   * @return A new LineInfo RecordBuilder
   */
  public static LineInfo.Builder newBuilder(LineInfo other) {
    if (other == null) {
      return new LineInfo.Builder();
    } else {
      return new LineInfo.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineInfo>
    ...
    private CharSequence updatedAt;
    private MarketType marketType;
    private MarketType.Builder marketTypeBuilder;
    private LineEntity lineEntity;
    private LineEntity.Builder lineEntityBuilder;
    private GamePeriod gamePeriod;
    private GamePeriod.Builder gamePeriodBuilder;
    private Boolean isValid;
    private Double spread;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(LineInfo.Builder other) {
      super(other);
      ...
      if (other.hasMarketTypeBuilder()) {
        this.marketTypeBuilder = MarketType.newBuilder(other.getMarketTypeBuilder());
      }
      ...
      if (other.hasLineEntityBuilder()) {
        this.lineEntityBuilder = LineEntity.newBuilder(other.getLineEntityBuilder());
      }
      ...
      if (other.hasGamePeriodBuilder()) {
        this.gamePeriodBuilder = GamePeriod.newBuilder(other.getGamePeriodBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(LineInfo other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder setId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder setIndex(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder clearIndex() {
      index = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder setUpdatedAt(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder clearUpdatedAt() {
      updatedAt = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder setMarketType(MarketType value) {
     ...
     * @return This builder.
     */
    public MarketType.Builder getMarketTypeBuilder() {
      if (marketTypeBuilder == null) {
        if (hasMarketType()) {
          setMarketTypeBuilder(MarketType.newBuilder(marketType));
        } else {
          setMarketTypeBuilder(MarketType.newBuilder());
        }
      }
    ...
    public LineInfo.Builder setMarketTypeBuilder(MarketType.Builder value) {
      clearMarketType();
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder clearMarketType() {
      marketType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder setLineEntity(LineEntity value) {
     ...
     * @return This builder.
     */
    public LineEntity.Builder getLineEntityBuilder() {
      if (lineEntityBuilder == null) {
        if (hasLineEntity()) {
          setLineEntityBuilder(LineEntity.newBuilder(lineEntity));
        } else {
          setLineEntityBuilder(LineEntity.newBuilder());
        }
      }
    ...
    public LineInfo.Builder setLineEntityBuilder(LineEntity.Builder value) {
      clearLineEntity();
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder clearLineEntity() {
      lineEntity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder setGamePeriod(GamePeriod value) {
     ...
     * @return This builder.
     */
    public GamePeriod.Builder getGamePeriodBuilder() {
      if (gamePeriodBuilder == null) {
        if (hasGamePeriod()) {
          setGamePeriodBuilder(GamePeriod.newBuilder(gamePeriod));
        } else {
          setGamePeriodBuilder(GamePeriod.newBuilder());
        }
      }
    ...
    public LineInfo.Builder setGamePeriodBuilder(GamePeriod.Builder value) {
      clearGamePeriod();
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder clearGamePeriod() {
      gamePeriod = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder setIsValid(Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder clearIsValid() {
      isValid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder setSpread(Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LineInfo.Builder clearSpread() {
      spread = null;
    ...
    public LineInfo build() {
      try {
        ...
        if (marketTypeBuilder != null) {
          ...
          record.marketType = fieldSetFlags()[3] ? this.marketType : (MarketType) defaultValue(fields()[3]);
        }
        if (lineEntityBuilder != null) {
          try {
          ...
          record.lineEntity = fieldSetFlags()[4] ? this.lineEntity : (LineEntity) defaultValue(fields()[4]);
        }
        if (gamePeriodBuilder != null) {
          try {
          ...
          record.gamePeriod = fieldSetFlags()[5] ? this.gamePeriod : (GamePeriod) defaultValue(fields()[5]);
        }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.marketType == null) {
          this.marketType = new MarketType();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.gamePeriod == null) {
          this.gamePeriod = new GamePeriod();
        }
