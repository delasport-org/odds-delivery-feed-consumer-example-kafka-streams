...
public class EventSportsStreamMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private java.util.List<LiveScores> liveScores;
  private java.util.Map<CharSequence,java.util.Map<CharSequence, Score>> typedScores;
   ...
   */
  public EventSportsStreamMessage(Origin origin, CharSequence id, EventInfo eventInfo, java.util.List<LiveScores> liveScores, java.util.Map<CharSequence,java.util.Map<CharSequence, Score>> typedScores, CharSequence timestamp) {
    this.origin = origin;
    this.id = id;
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: liveScores = (java.util.List<LiveScores>)value$; break;
    case 4: typedScores = (java.util.Map<CharSequence,java.util.Map<CharSequence, Score>>)value$; break;
   ...
   */
  public java.util.List<LiveScores> getLiveScores() {
    return liveScores;
  }
   ...
   * @param value the value to set.
   */
  public void setLiveScores(java.util.List<LiveScores> value) {
   ...
   */
  public java.util.Map<CharSequence,java.util.Map<CharSequence, Score>> getTypedScores() {
    return typedScores;
  }
   ...
   * @param value the value to set.
   */
  public void setTypedScores(java.util.Map<CharSequence,java.util.Map<CharSequence, Score>> value) {
   ...
   */
  public static EventSportsStreamMessage.Builder newBuilder() {
    return new EventSportsStreamMessage.Builder();
  }
   ...
   * @return A new EventSportsStreamMessage RecordBuilder
   */
  public static EventSportsStreamMessage.Builder newBuilder(EventSportsStreamMessage.Builder other) {
    if (other == null) {
      return new EventSportsStreamMessage.Builder();
    } else {
      return new EventSportsStreamMessage.Builder(other);
    }
  }
   ...
   * @return A new EventSportsStreamMessage RecordBuilder
   */
  public static EventSportsStreamMessage.Builder newBuilder(EventSportsStreamMessage other) {
    if (other == null) {
      return new EventSportsStreamMessage.Builder();
    } else {
      return new EventSportsStreamMessage.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventSportsStreamMessage>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(EventSportsStreamMessage.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(EventSportsStreamMessage other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.origin)) {
        this.origin = data().deepCopy(fields()[0].schema(), other.origin);
    ...
    /**
      ...
      * @return This builder.
      */
    public EventSportsStreamMessage.Builder setOrigin(Origin value) {
    ...
    public EventSportsStreamMessage.Builder setOriginBuilder(Origin.Builder value) {
      clearOrigin();
      originBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public EventSportsStreamMessage.Builder clearOrigin() {
      origin = null;
      originBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public EventSportsStreamMessage.Builder setId(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public EventSportsStreamMessage.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public EventSportsStreamMessage.Builder setEventInfo(EventInfo value) {
    ...
    public EventSportsStreamMessage.Builder setEventInfoBuilder(EventInfo.Builder value) {
      clearEventInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public EventSportsStreamMessage.Builder clearEventInfo() {
      eventInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public EventSportsStreamMessage.Builder setLiveScores(java.util.List<LiveScores> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public EventSportsStreamMessage.Builder clearLiveScores() {
      liveScores = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public EventSportsStreamMessage.Builder setTypedScores(java.util.Map<CharSequence,java.util.Map<CharSequence, Score>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public EventSportsStreamMessage.Builder clearTypedScores() {
      typedScores = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public EventSportsStreamMessage.Builder setTimestamp(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public EventSportsStreamMessage.Builder clearTimestamp() {
      timestamp = null;
    ...
    public EventSportsStreamMessage build() {
      try {
        ...
        record.liveScores = fieldSetFlags()[3] ? this.liveScores : (java.util.List<LiveScores>) defaultValue(fields()[3]);
        record.typedScores = fieldSetFlags()[4] ? this.typedScores : (java.util.Map<CharSequence,java.util.Map<CharSequence, Score>>) defaultValue(fields()[4]);
    ...
    throws java.io.IOException
  {
    ...
    if (this.liveScores == null) {
      ...
      long actualSize0 = 0;
      for (LiveScores e0: this.liveScores) {
        actualSize0++;
        out.startItem();
        e0.customEncode(out);
      }
    ...
    if (this.typedScores == null) {
      ...
      long actualSize1 = 0;
      for (java.util.Map.Entry<CharSequence, java.util.Map<CharSequence, Score>> e1: this.typedScores.entrySet()) {
        actualSize1++;
        out.startItem();
        out.writeString(e1.getKey());
        java.util.Map<CharSequence, Score> v1 = e1.getValue();
        long size2 = v1.size();
        out.writeMapStart();
        out.setItemCount(size2);
        long actualSize2 = 0;
        for (java.util.Map.Entry<CharSequence, Score> e2: v1.entrySet()) {
          actualSize2++;
          out.startItem();
          out.writeString(e2.getKey());
          Score v2 = e2.getValue();
          v2.customEncode(out);
        }
        out.writeMapEnd();
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        java.util.List<LiveScores> a0 = this.liveScores;
        if (a0 == null) {
          a0 = new SpecificData.Array<LiveScores>((int)size0, SCHEMA$.getField("liveScores").schema().getTypes().get(1));
          this.liveScores = a0;
        } else a0.clear();
        SpecificData.Array<LiveScores> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<LiveScores>)a0 : null);
        for ( ; 0 < size0; size0 = in.arrayNext()) {
          for ( ; size0 != 0; size0--) {
            LiveScores e0 = (ga0 != null ? ga0.peek() : null);
            if (e0 == null) {
              e0 = new LiveScores();
            }
            e0.customDecode(in);
      ...
      if (in.readIndex() != 1) {
        ...
        java.util.Map<CharSequence,java.util.Map<CharSequence, Score>> m1 = this.typedScores; // Need fresh name due to limitation of macro system
        if (m1 == null) {
          m1 = new java.util.HashMap<CharSequence,java.util.Map<CharSequence, Score>>((int)size1);
          this.typedScores = m1;
        } else m1.clear();
        for ( ; 0 < size1; size1 = in.mapNext()) {
          for ( ; size1 != 0; size1--) {
            ...
            java.util.Map<CharSequence, Score> v1 = null;
            long size2 = in.readMapStart();
            java.util.Map<CharSequence, Score> m2 = v1; // Need fresh name due to limitation of macro system
            if (m2 == null) {
              m2 = new java.util.HashMap<CharSequence, Score>((int)size2);
              v1 = m2;
            } else m2.clear();
