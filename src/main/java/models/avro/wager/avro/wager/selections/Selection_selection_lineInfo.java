...
public class Selection_selection_lineInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Selection_selection_lineInfo(Long id, CharSequence index, CharSequence updatedAt, Selection_selection_lineInfo_marketType marketType, Selection_selection_lineInfo_lineEntity lineEntity, Selection_selection_lineInfo_gamePeriod gamePeriod, Boolean isValid, Double spread) {
    this.id = id;
    this.index = index;
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: marketType = (Selection_selection_lineInfo_marketType)value$; break;
    case 4: lineEntity = (Selection_selection_lineInfo_lineEntity)value$; break;
    case 5: gamePeriod = (Selection_selection_lineInfo_gamePeriod)value$; break;
   ...
   */
  public Selection_selection_lineInfo_marketType getMarketType() {
    return marketType;
  }
   ...
   * @param value the value to set.
   */
  public void setMarketType(Selection_selection_lineInfo_marketType value) {
   ...
   */
  public Selection_selection_lineInfo_lineEntity getLineEntity() {
    return lineEntity;
  }
   ...
   * @param value the value to set.
   */
  public void setLineEntity(Selection_selection_lineInfo_lineEntity value) {
   ...
   */
  public Selection_selection_lineInfo_gamePeriod getGamePeriod() {
    return gamePeriod;
  }
   ...
   * @param value the value to set.
   */
  public void setGamePeriod(Selection_selection_lineInfo_gamePeriod value) {
   ...
   */
  public static Selection_selection_lineInfo.Builder newBuilder() {
    return new Selection_selection_lineInfo.Builder();
  }
   ...
   * @return A new Selection_selection_lineInfo RecordBuilder
   */
  public static Selection_selection_lineInfo.Builder newBuilder(Selection_selection_lineInfo.Builder other) {
    if (other == null) {
      return new Selection_selection_lineInfo.Builder();
    } else {
      return new Selection_selection_lineInfo.Builder(other);
    }
  }
   ...
   * @return A new Selection_selection_lineInfo RecordBuilder
   */
  public static Selection_selection_lineInfo.Builder newBuilder(Selection_selection_lineInfo other) {
    if (other == null) {
      return new Selection_selection_lineInfo.Builder();
    } else {
      return new Selection_selection_lineInfo.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Selection_selection_lineInfo>
    ...
    private CharSequence updatedAt;
    private Selection_selection_lineInfo_marketType marketType;
    private Selection_selection_lineInfo_marketType.Builder marketTypeBuilder;
    private Selection_selection_lineInfo_lineEntity lineEntity;
    private Selection_selection_lineInfo_lineEntity.Builder lineEntityBuilder;
    private Selection_selection_lineInfo_gamePeriod gamePeriod;
    private Selection_selection_lineInfo_gamePeriod.Builder gamePeriodBuilder;
    private Boolean isValid;
    private Double spread;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Selection_selection_lineInfo.Builder other) {
      super(other);
      ...
      if (other.hasMarketTypeBuilder()) {
        this.marketTypeBuilder = Selection_selection_lineInfo_marketType.newBuilder(other.getMarketTypeBuilder());
      }
      ...
      if (other.hasLineEntityBuilder()) {
        this.lineEntityBuilder = Selection_selection_lineInfo_lineEntity.newBuilder(other.getLineEntityBuilder());
      }
      ...
      if (other.hasGamePeriodBuilder()) {
        this.gamePeriodBuilder = Selection_selection_lineInfo_gamePeriod.newBuilder(other.getGamePeriodBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Selection_selection_lineInfo other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder setId(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder setIndex(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder clearIndex() {
      index = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder setUpdatedAt(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder clearUpdatedAt() {
      updatedAt = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder setMarketType(Selection_selection_lineInfo_marketType value) {
     ...
     * @return This builder.
     */
    public Selection_selection_lineInfo_marketType.Builder getMarketTypeBuilder() {
      if (marketTypeBuilder == null) {
        if (hasMarketType()) {
          setMarketTypeBuilder(Selection_selection_lineInfo_marketType.newBuilder(marketType));
        } else {
          setMarketTypeBuilder(Selection_selection_lineInfo_marketType.newBuilder());
        }
      }
    ...
    public Selection_selection_lineInfo.Builder setMarketTypeBuilder(Selection_selection_lineInfo_marketType.Builder value) {
      clearMarketType();
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder clearMarketType() {
      marketType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder setLineEntity(Selection_selection_lineInfo_lineEntity value) {
     ...
     * @return This builder.
     */
    public Selection_selection_lineInfo_lineEntity.Builder getLineEntityBuilder() {
      if (lineEntityBuilder == null) {
        if (hasLineEntity()) {
          setLineEntityBuilder(Selection_selection_lineInfo_lineEntity.newBuilder(lineEntity));
        } else {
          setLineEntityBuilder(Selection_selection_lineInfo_lineEntity.newBuilder());
        }
      }
    ...
    public Selection_selection_lineInfo.Builder setLineEntityBuilder(Selection_selection_lineInfo_lineEntity.Builder value) {
      clearLineEntity();
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder clearLineEntity() {
      lineEntity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder setGamePeriod(Selection_selection_lineInfo_gamePeriod value) {
     ...
     * @return This builder.
     */
    public Selection_selection_lineInfo_gamePeriod.Builder getGamePeriodBuilder() {
      if (gamePeriodBuilder == null) {
        if (hasGamePeriod()) {
          setGamePeriodBuilder(Selection_selection_lineInfo_gamePeriod.newBuilder(gamePeriod));
        } else {
          setGamePeriodBuilder(Selection_selection_lineInfo_gamePeriod.newBuilder());
        }
      }
    ...
    public Selection_selection_lineInfo.Builder setGamePeriodBuilder(Selection_selection_lineInfo_gamePeriod.Builder value) {
      clearGamePeriod();
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder clearGamePeriod() {
      gamePeriod = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder setIsValid(Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder clearIsValid() {
      isValid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder setSpread(Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo.Builder clearSpread() {
      spread = null;
    ...
    public Selection_selection_lineInfo build() {
      try {
        ...
        if (marketTypeBuilder != null) {
          ...
          record.marketType = fieldSetFlags()[3] ? this.marketType : (Selection_selection_lineInfo_marketType) defaultValue(fields()[3]);
        }
        if (lineEntityBuilder != null) {
          try {
          ...
          record.lineEntity = fieldSetFlags()[4] ? this.lineEntity : (Selection_selection_lineInfo_lineEntity) defaultValue(fields()[4]);
        }
        if (gamePeriodBuilder != null) {
          try {
          ...
          record.gamePeriod = fieldSetFlags()[5] ? this.gamePeriod : (Selection_selection_lineInfo_gamePeriod) defaultValue(fields()[5]);
        }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.marketType == null) {
          this.marketType = new Selection_selection_lineInfo_marketType();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.lineEntity == null) {
          this.lineEntity = new Selection_selection_lineInfo_lineEntity();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.gamePeriod == null) {
          this.gamePeriod = new Selection_selection_lineInfo_gamePeriod();
        }
