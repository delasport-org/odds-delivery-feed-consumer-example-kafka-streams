...
public class Wager_potentialWinnings_wallet extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Wager_potentialWinnings_wallet(Wager_potentialWinnings_wallet_compartment compartment) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: compartment = (Wager_potentialWinnings_wallet_compartment)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public Wager_potentialWinnings_wallet_compartment getCompartment() {
    return compartment;
  }
   ...
   */
  public void setCompartment(Wager_potentialWinnings_wallet_compartment value) {
   ...
   */
  public static Wager_potentialWinnings_wallet.Builder newBuilder() {
    return new Wager_potentialWinnings_wallet.Builder();
  }
   ...
   * @return A new Wager_potentialWinnings_wallet RecordBuilder
   */
  public static Wager_potentialWinnings_wallet.Builder newBuilder(Wager_potentialWinnings_wallet.Builder other) {
    if (other == null) {
      return new Wager_potentialWinnings_wallet.Builder();
    } else {
      return new Wager_potentialWinnings_wallet.Builder(other);
    }
  }
   ...
   * @return A new Wager_potentialWinnings_wallet RecordBuilder
   */
  public static Wager_potentialWinnings_wallet.Builder newBuilder(Wager_potentialWinnings_wallet other) {
    if (other == null) {
      return new Wager_potentialWinnings_wallet.Builder();
    } else {
      return new Wager_potentialWinnings_wallet.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Wager_potentialWinnings_wallet>
    ...
    private Wager_potentialWinnings_wallet_compartment compartment;
    private Wager_potentialWinnings_wallet_compartment.Builder compartmentBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Wager_potentialWinnings_wallet.Builder other) {
      super(other);
      ...
      if (other.hasCompartmentBuilder()) {
        this.compartmentBuilder = Wager_potentialWinnings_wallet_compartment.newBuilder(other.getCompartmentBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Wager_potentialWinnings_wallet other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.compartment)) {
        this.compartment = data().deepCopy(fields()[0].schema(), other.compartment);
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager_potentialWinnings_wallet.Builder setCompartment(Wager_potentialWinnings_wallet_compartment value) {
     ...
     * @return This builder.
     */
    public Wager_potentialWinnings_wallet_compartment.Builder getCompartmentBuilder() {
      if (compartmentBuilder == null) {
        if (hasCompartment()) {
          setCompartmentBuilder(Wager_potentialWinnings_wallet_compartment.newBuilder(compartment));
        } else {
          setCompartmentBuilder(Wager_potentialWinnings_wallet_compartment.newBuilder());
        }
      }
    ...
    public Wager_potentialWinnings_wallet.Builder setCompartmentBuilder(Wager_potentialWinnings_wallet_compartment.Builder value) {
      clearCompartment();
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager_potentialWinnings_wallet.Builder clearCompartment() {
      compartment = null;
    ...
    public Wager_potentialWinnings_wallet build() {
      try {
        ...
        if (compartmentBuilder != null) {
          ...
          record.compartment = fieldSetFlags()[0] ? this.compartment : (Wager_potentialWinnings_wallet_compartment) defaultValue(fields()[0]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.compartment == null) {
          this.compartment = new Wager_potentialWinnings_wallet_compartment();
        }
