...
public class Selection_selection_lineInfo_lineEntity extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static Selection_selection_lineInfo_lineEntity.Builder newBuilder() {
    return new Selection_selection_lineInfo_lineEntity.Builder();
  }
   ...
   * @return A new Selection_selection_lineInfo_lineEntity RecordBuilder
   */
  public static Selection_selection_lineInfo_lineEntity.Builder newBuilder(Selection_selection_lineInfo_lineEntity.Builder other) {
    if (other == null) {
      return new Selection_selection_lineInfo_lineEntity.Builder();
    } else {
      return new Selection_selection_lineInfo_lineEntity.Builder(other);
    }
  }
   ...
   * @return A new Selection_selection_lineInfo_lineEntity RecordBuilder
   */
  public static Selection_selection_lineInfo_lineEntity.Builder newBuilder(Selection_selection_lineInfo_lineEntity other) {
    if (other == null) {
      return new Selection_selection_lineInfo_lineEntity.Builder();
    } else {
      return new Selection_selection_lineInfo_lineEntity.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Selection_selection_lineInfo_lineEntity>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Selection_selection_lineInfo_lineEntity.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Selection_selection_lineInfo_lineEntity other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo_lineEntity.Builder setId(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo_lineEntity.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo_lineEntity.Builder setName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_lineInfo_lineEntity.Builder clearName() {
      name = null;
