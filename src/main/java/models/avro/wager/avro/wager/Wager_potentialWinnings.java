...
public class Wager_potentialWinnings extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Wager_potentialWinnings(Double amount, Wager_potentialWinnings_wallet wallet) {
    this.amount = amount;
    this.wallet = wallet;
  }
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: wallet = (Wager_potentialWinnings_wallet)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public Wager_potentialWinnings_wallet getWallet() {
    return wallet;
  }
   ...
   * @param value the value to set.
   */
  public void setWallet(Wager_potentialWinnings_wallet value) {
    this.wallet = value;
  }
   ...
   */
  public static Wager_potentialWinnings.Builder newBuilder() {
    return new Wager_potentialWinnings.Builder();
  }
   ...
   * @return A new Wager_potentialWinnings RecordBuilder
   */
  public static Wager_potentialWinnings.Builder newBuilder(Wager_potentialWinnings.Builder other) {
    if (other == null) {
      return new Wager_potentialWinnings.Builder();
    } else {
      return new Wager_potentialWinnings.Builder(other);
    }
  }
   ...
   * @return A new Wager_potentialWinnings RecordBuilder
   */
  public static Wager_potentialWinnings.Builder newBuilder(Wager_potentialWinnings other) {
    if (other == null) {
      return new Wager_potentialWinnings.Builder();
    } else {
      return new Wager_potentialWinnings.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Wager_potentialWinnings>
    ...
    private Double amount;
    private Wager_potentialWinnings_wallet wallet;
    private Wager_potentialWinnings_wallet.Builder walletBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Wager_potentialWinnings.Builder other) {
      super(other);
      ...
      if (other.hasWalletBuilder()) {
        this.walletBuilder = Wager_potentialWinnings_wallet.newBuilder(other.getWalletBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Wager_potentialWinnings other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.amount)) {
        this.amount = data().deepCopy(fields()[0].schema(), other.amount);
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager_potentialWinnings.Builder setAmount(Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager_potentialWinnings.Builder clearAmount() {
      amount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager_potentialWinnings.Builder setWallet(Wager_potentialWinnings_wallet value) {
     ...
     * @return This builder.
     */
    public Wager_potentialWinnings_wallet.Builder getWalletBuilder() {
      if (walletBuilder == null) {
        if (hasWallet()) {
          setWalletBuilder(Wager_potentialWinnings_wallet.newBuilder(wallet));
        } else {
          setWalletBuilder(Wager_potentialWinnings_wallet.newBuilder());
        }
      }
    ...
    public Wager_potentialWinnings.Builder setWalletBuilder(Wager_potentialWinnings_wallet.Builder value) {
      clearWallet();
      walletBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager_potentialWinnings.Builder clearWallet() {
      wallet = null;
      walletBuilder = null;
    ...
    public Wager_potentialWinnings build() {
      try {
        ...
        if (walletBuilder != null) {
          ...
          record.wallet = fieldSetFlags()[1] ? this.wallet : (Wager_potentialWinnings_wallet) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.wallet == null) {
          this.wallet = new Wager_potentialWinnings_wallet();
        }
