...
public class Selection_selection_eventInfo_teams extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Selection_selection_eventInfo_teams(Selection_selection_eventInfo_teams_home home, Selection_selection_eventInfo_teams_away away) {
    this.home = home;
    this.away = away;
  }
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: home = (Selection_selection_eventInfo_teams_home)value$; break;
    case 1: away = (Selection_selection_eventInfo_teams_away)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public Selection_selection_eventInfo_teams_home getHome() {
    return home;
  }
   ...
   */
  public void setHome(Selection_selection_eventInfo_teams_home value) {
    this.home = value;
  }
   ...
   */
  public Selection_selection_eventInfo_teams_away getAway() {
    return away;
  }
   ...
   * @param value the value to set.
   */
  public void setAway(Selection_selection_eventInfo_teams_away value) {
    this.away = value;
  }
   ...
   */
  public static Selection_selection_eventInfo_teams.Builder newBuilder() {
    return new Selection_selection_eventInfo_teams.Builder();
  }
   ...
   * @return A new Selection_selection_eventInfo_teams RecordBuilder
   */
  public static Selection_selection_eventInfo_teams.Builder newBuilder(Selection_selection_eventInfo_teams.Builder other) {
    if (other == null) {
      return new Selection_selection_eventInfo_teams.Builder();
    } else {
      return new Selection_selection_eventInfo_teams.Builder(other);
    }
  }
   ...
   * @return A new Selection_selection_eventInfo_teams RecordBuilder
   */
  public static Selection_selection_eventInfo_teams.Builder newBuilder(Selection_selection_eventInfo_teams other) {
    if (other == null) {
      return new Selection_selection_eventInfo_teams.Builder();
    } else {
      return new Selection_selection_eventInfo_teams.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Selection_selection_eventInfo_teams>
    ...
    private Selection_selection_eventInfo_teams_home home;
    private Selection_selection_eventInfo_teams_home.Builder homeBuilder;
    private Selection_selection_eventInfo_teams_away away;
    private Selection_selection_eventInfo_teams_away.Builder awayBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Selection_selection_eventInfo_teams.Builder other) {
      super(other);
      ...
      if (other.hasHomeBuilder()) {
        this.homeBuilder = Selection_selection_eventInfo_teams_home.newBuilder(other.getHomeBuilder());
      }
      ...
      if (other.hasAwayBuilder()) {
        this.awayBuilder = Selection_selection_eventInfo_teams_away.newBuilder(other.getAwayBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Selection_selection_eventInfo_teams other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.home)) {
        this.home = data().deepCopy(fields()[0].schema(), other.home);
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_eventInfo_teams.Builder setHome(Selection_selection_eventInfo_teams_home value) {
     ...
     * @return This builder.
     */
    public Selection_selection_eventInfo_teams_home.Builder getHomeBuilder() {
      if (homeBuilder == null) {
        if (hasHome()) {
          setHomeBuilder(Selection_selection_eventInfo_teams_home.newBuilder(home));
        } else {
          setHomeBuilder(Selection_selection_eventInfo_teams_home.newBuilder());
        }
      }
      return homeBuilder;
    }
    ...
    public Selection_selection_eventInfo_teams.Builder setHomeBuilder(Selection_selection_eventInfo_teams_home.Builder value) {
      clearHome();
      homeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_eventInfo_teams.Builder clearHome() {
      home = null;
      homeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_eventInfo_teams.Builder setAway(Selection_selection_eventInfo_teams_away value) {
     ...
     * @return This builder.
     */
    public Selection_selection_eventInfo_teams_away.Builder getAwayBuilder() {
      if (awayBuilder == null) {
        if (hasAway()) {
          setAwayBuilder(Selection_selection_eventInfo_teams_away.newBuilder(away));
        } else {
          setAwayBuilder(Selection_selection_eventInfo_teams_away.newBuilder());
        }
      }
      return awayBuilder;
    }
    ...
    public Selection_selection_eventInfo_teams.Builder setAwayBuilder(Selection_selection_eventInfo_teams_away.Builder value) {
      clearAway();
      awayBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection_eventInfo_teams.Builder clearAway() {
      away = null;
      awayBuilder = null;
    ...
    public Selection_selection_eventInfo_teams build() {
      try {
        ...
        if (homeBuilder != null) {
          ...
          record.home = fieldSetFlags()[0] ? this.home : (Selection_selection_eventInfo_teams_home) defaultValue(fields()[0]);
        }
        if (awayBuilder != null) {
          try {
          ...
          record.away = fieldSetFlags()[1] ? this.away : (Selection_selection_eventInfo_teams_away) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.home == null) {
          this.home = new Selection_selection_eventInfo_teams_home();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.away == null) {
          this.away = new Selection_selection_eventInfo_teams_away();
        }
