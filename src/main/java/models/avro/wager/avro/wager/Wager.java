...
import models.avro.wager.avro.wager.selections.Selection_selection;
...
public class Wager extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private java.util.List<Selection_selection> selections;
   ...
   */
  public Wager(Wager_origin origin, Long id, CharSequence type, CharSequence status, CharSequence source, Wager_member member, Wager_session session, Wager_currency currency, Wager_brand brand, Wager_odds odds, Wager_stake stake, Wager_potentialWinnings potentialWinnings, Wager_gain gain, Integer numberOfSelections, CharSequence createdAt, CharSequence updatedAt, CharSequence handledAt, CharSequence acceptedAt, CharSequence timestamp, java.util.List<Integer> selectedSystems, CharSequence systemGroupName, CharSequence selectionCombineKey, java.util.List<Selection_selection> selections) {
    this.origin = origin;
    this.id = id;
    this.type = type;
    this.status = status;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: origin = (Wager_origin)value$; break;
    ...
    case 5: member = (Wager_member)value$; break;
    case 6: session = (Wager_session)value$; break;
    case 7: currency = (Wager_currency)value$; break;
    case 8: brand = (Wager_brand)value$; break;
    case 9: odds = (Wager_odds)value$; break;
    case 10: stake = (Wager_stake)value$; break;
    case 11: potentialWinnings = (Wager_potentialWinnings)value$; break;
    case 12: gain = (Wager_gain)value$; break;
    ...
    case 22: selections = (java.util.List<Selection_selection>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public void setOrigin(Wager_origin value) {
    this.origin = value;
  }
   ...
   * @param value the value to set.
   */
  public void setMember(Wager_member value) {
    this.member = value;
  }
   ...
   */
  public Wager_session getSession() {
    return session;
  }
   ...
   * @param value the value to set.
   */
  public void setSession(Wager_session value) {
    this.session = value;
  }
   ...
   */
  public Wager_currency getCurrency() {
    return currency;
  }
   ...
   * @param value the value to set.
   */
  public void setCurrency(Wager_currency value) {
    this.currency = value;
  }
   ...
   * @param value the value to set.
   */
  public void setBrand(Wager_brand value) {
    this.brand = value;
  }
   ...
   * @param value the value to set.
   */
  public void setOdds(Wager_odds value) {
    this.odds = value;
  }
   ...
   * @param value the value to set.
   */
  public void setStake(Wager_stake value) {
    this.stake = value;
  }
   ...
   */
  public Wager_potentialWinnings getPotentialWinnings() {
   ...
   * @param value the value to set.
   */
  public void setPotentialWinnings(Wager_potentialWinnings value) {
   ...
   * @param value the value to set.
   */
  public void setGain(Wager_gain value) {
    this.gain = value;
  }
   ...
   */
  public java.util.List<Selection_selection> getSelections() {
    return selections;
  }
   ...
   * @param value the value to set.
   */
  public void setSelections(java.util.List<Selection_selection> value) {
   ...
   */
  public static Wager.Builder newBuilder() {
   ...
   * @return A new Wager RecordBuilder
   */
  public static Wager.Builder newBuilder(Wager.Builder other) {
    if (other == null) {
      return new Wager.Builder();
    } else {
      return new Wager.Builder(other);
    }
  }
   ...
   * @return A new Wager RecordBuilder
   */
  public static Wager.Builder newBuilder(Wager other) {
    if (other == null) {
      return new Wager.Builder();
    } else {
      return new Wager.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Wager>
    ...
    private Wager_origin origin;
    private Wager_origin.Builder originBuilder;
    private Long id;
    private CharSequence type;
    private CharSequence status;
    private CharSequence source;
    private Wager_member member;
    private Wager_member.Builder memberBuilder;
    private Wager_session session;
    private Wager_session.Builder sessionBuilder;
    private Wager_currency currency;
    private Wager_currency.Builder currencyBuilder;
    private Wager_brand brand;
    private Wager_brand.Builder brandBuilder;
    private Wager_odds odds;
    private Wager_odds.Builder oddsBuilder;
    private Wager_stake stake;
    private Wager_stake.Builder stakeBuilder;
    private Wager_potentialWinnings potentialWinnings;
    private Wager_potentialWinnings.Builder potentialWinningsBuilder;
    private Wager_gain gain;
    private Wager_gain.Builder gainBuilder;
    private Integer numberOfSelections;
    private CharSequence createdAt;
    private CharSequence updatedAt;
    private CharSequence handledAt;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Wager.Builder other) {
      super(other);
      ...
      if (other.hasOriginBuilder()) {
        this.originBuilder = Wager_origin.newBuilder(other.getOriginBuilder());
      }
      ...
      if (other.hasMemberBuilder()) {
        this.memberBuilder = Wager_member.newBuilder(other.getMemberBuilder());
      }
      ...
      if (other.hasSessionBuilder()) {
        this.sessionBuilder = Wager_session.newBuilder(other.getSessionBuilder());
      }
      ...
      if (other.hasCurrencyBuilder()) {
        this.currencyBuilder = Wager_currency.newBuilder(other.getCurrencyBuilder());
      }
      ...
      if (other.hasBrandBuilder()) {
        this.brandBuilder = Wager_brand.newBuilder(other.getBrandBuilder());
      }
      ...
      if (other.hasOddsBuilder()) {
        this.oddsBuilder = Wager_odds.newBuilder(other.getOddsBuilder());
      }
      ...
      if (other.hasStakeBuilder()) {
        this.stakeBuilder = Wager_stake.newBuilder(other.getStakeBuilder());
      }
      ...
      if (other.hasPotentialWinningsBuilder()) {
        this.potentialWinningsBuilder = Wager_potentialWinnings.newBuilder(other.getPotentialWinningsBuilder());
      }
      ...
      if (other.hasGainBuilder()) {
        this.gainBuilder = Wager_gain.newBuilder(other.getGainBuilder());
      }
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setOrigin(Wager_origin value) {
     ...
     * @return This builder.
     */
    public Wager_origin.Builder getOriginBuilder() {
      if (originBuilder == null) {
        if (hasOrigin()) {
          setOriginBuilder(Wager_origin.newBuilder(origin));
        } else {
          setOriginBuilder(Wager_origin.newBuilder());
        }
      }
    ...
    public Wager.Builder setOriginBuilder(Wager_origin.Builder value) {
      clearOrigin();
      originBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearOrigin() {
      origin = null;
      originBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setId(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setType(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setStatus(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setSource(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearSource() {
      source = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setMember(Wager_member value) {
     ...
     * @return This builder.
     */
    public Wager_member.Builder getMemberBuilder() {
      if (memberBuilder == null) {
        if (hasMember()) {
          setMemberBuilder(Wager_member.newBuilder(member));
        } else {
          setMemberBuilder(Wager_member.newBuilder());
        }
      }
    ...
    public Wager.Builder setMemberBuilder(Wager_member.Builder value) {
      clearMember();
      memberBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearMember() {
      member = null;
      memberBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setSession(Wager_session value) {
     ...
     * @return This builder.
     */
    public Wager_session.Builder getSessionBuilder() {
      if (sessionBuilder == null) {
        if (hasSession()) {
          setSessionBuilder(Wager_session.newBuilder(session));
        } else {
          setSessionBuilder(Wager_session.newBuilder());
        }
      }
    ...
    public Wager.Builder setSessionBuilder(Wager_session.Builder value) {
      clearSession();
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearSession() {
      session = null;
      sessionBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setCurrency(Wager_currency value) {
     ...
     * @return This builder.
     */
    public Wager_currency.Builder getCurrencyBuilder() {
      if (currencyBuilder == null) {
        if (hasCurrency()) {
          setCurrencyBuilder(Wager_currency.newBuilder(currency));
        } else {
          setCurrencyBuilder(Wager_currency.newBuilder());
        }
      }
    ...
    public Wager.Builder setCurrencyBuilder(Wager_currency.Builder value) {
      clearCurrency();
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearCurrency() {
      currency = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setBrand(Wager_brand value) {
     ...
     * @return This builder.
     */
    public Wager_brand.Builder getBrandBuilder() {
      if (brandBuilder == null) {
        if (hasBrand()) {
          setBrandBuilder(Wager_brand.newBuilder(brand));
        } else {
          setBrandBuilder(Wager_brand.newBuilder());
        }
      }
      return brandBuilder;
    }
    ...
    public Wager.Builder setBrandBuilder(Wager_brand.Builder value) {
      clearBrand();
      brandBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearBrand() {
      brand = null;
      brandBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setOdds(Wager_odds value) {
     ...
     * @return This builder.
     */
    public Wager_odds.Builder getOddsBuilder() {
      if (oddsBuilder == null) {
        if (hasOdds()) {
          setOddsBuilder(Wager_odds.newBuilder(odds));
        } else {
          setOddsBuilder(Wager_odds.newBuilder());
        }
      }
      return oddsBuilder;
    }
    ...
    public Wager.Builder setOddsBuilder(Wager_odds.Builder value) {
      clearOdds();
      oddsBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearOdds() {
      odds = null;
      oddsBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setStake(Wager_stake value) {
     ...
     * @return This builder.
     */
    public Wager_stake.Builder getStakeBuilder() {
      if (stakeBuilder == null) {
        if (hasStake()) {
          setStakeBuilder(Wager_stake.newBuilder(stake));
        } else {
          setStakeBuilder(Wager_stake.newBuilder());
        }
      }
      return stakeBuilder;
    }
    ...
    public Wager.Builder setStakeBuilder(Wager_stake.Builder value) {
      clearStake();
      stakeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearStake() {
      stake = null;
      stakeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setPotentialWinnings(Wager_potentialWinnings value) {
     ...
     * @return This builder.
     */
    public Wager_potentialWinnings.Builder getPotentialWinningsBuilder() {
      if (potentialWinningsBuilder == null) {
        if (hasPotentialWinnings()) {
          setPotentialWinningsBuilder(Wager_potentialWinnings.newBuilder(potentialWinnings));
        } else {
          setPotentialWinningsBuilder(Wager_potentialWinnings.newBuilder());
        }
      }
    ...
    public Wager.Builder setPotentialWinningsBuilder(Wager_potentialWinnings.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearPotentialWinnings() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setGain(Wager_gain value) {
     ...
     * @return This builder.
     */
    public Wager_gain.Builder getGainBuilder() {
      if (gainBuilder == null) {
        if (hasGain()) {
          setGainBuilder(Wager_gain.newBuilder(gain));
        } else {
          setGainBuilder(Wager_gain.newBuilder());
        }
      }
      return gainBuilder;
    }
    ...
    public Wager.Builder setGainBuilder(Wager_gain.Builder value) {
      clearGain();
      gainBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearGain() {
      gain = null;
      gainBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setNumberOfSelections(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearNumberOfSelections() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setCreatedAt(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearCreatedAt() {
      createdAt = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setUpdatedAt(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearUpdatedAt() {
      updatedAt = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setHandledAt(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearHandledAt() {
      handledAt = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setAcceptedAt(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearAcceptedAt() {
      acceptedAt = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setTimestamp(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearTimestamp() {
      timestamp = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setSelectedSystems(java.util.List<Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearSelectedSystems() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setSystemGroupName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearSystemGroupName() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setSelectionCombineKey(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearSelectionCombineKey() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder setSelections(java.util.List<Selection_selection> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager.Builder clearSelections() {
      selections = null;
    ...
    public Wager build() {
      try {
        ...
        if (originBuilder != null) {
          ...
          record.origin = fieldSetFlags()[0] ? this.origin : (Wager_origin) defaultValue(fields()[0]);
        }
        ...
        if (memberBuilder != null) {
          ...
          record.member = fieldSetFlags()[5] ? this.member : (Wager_member) defaultValue(fields()[5]);
        }
        if (sessionBuilder != null) {
          try {
          ...
          record.session = fieldSetFlags()[6] ? this.session : (Wager_session) defaultValue(fields()[6]);
        }
        if (currencyBuilder != null) {
          try {
          ...
          record.currency = fieldSetFlags()[7] ? this.currency : (Wager_currency) defaultValue(fields()[7]);
        }
        if (brandBuilder != null) {
          try {
          ...
          record.brand = fieldSetFlags()[8] ? this.brand : (Wager_brand) defaultValue(fields()[8]);
        }
        if (oddsBuilder != null) {
          try {
          ...
          record.odds = fieldSetFlags()[9] ? this.odds : (Wager_odds) defaultValue(fields()[9]);
        }
        if (stakeBuilder != null) {
          try {
          ...
          record.stake = fieldSetFlags()[10] ? this.stake : (Wager_stake) defaultValue(fields()[10]);
        }
        if (potentialWinningsBuilder != null) {
          try {
          ...
          record.potentialWinnings = fieldSetFlags()[11] ? this.potentialWinnings : (Wager_potentialWinnings) defaultValue(fields()[11]);
        }
        if (gainBuilder != null) {
          try {
          ...
          record.gain = fieldSetFlags()[12] ? this.gain : (Wager_gain) defaultValue(fields()[12]);
        }
        ...
        record.selections = fieldSetFlags()[22] ? this.selections : (java.util.List<Selection_selection>) defaultValue(fields()[22]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
      } catch (Exception e) {
    ...
    throws java.io.IOException
  {
    ...
    if (this.selections == null) {
      ...
      long actualSize1 = 0;
      for (Selection_selection e1: this.selections) {
        actualSize1++;
        out.startItem();
        e1.customEncode(out);
      }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.session == null) {
          this.session = new Wager_session();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.currency == null) {
          this.currency = new Wager_currency();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.potentialWinnings == null) {
          this.potentialWinnings = new Wager_potentialWinnings();
        }
      ...
      if (in.readIndex() != 0) {
        ...
        java.util.List<Selection_selection> a1 = this.selections;
        if (a1 == null) {
          a1 = new SpecificData.Array<Selection_selection>((int)size1, SCHEMA$.getField("selections").schema().getTypes().get(0));
          this.selections = a1;
        } else a1.clear();
        SpecificData.Array<Selection_selection> ga1 = (a1 instanceof SpecificData.Array ? (SpecificData.Array<Selection_selection>)a1 : null);
        for ( ; 0 < size1; size1 = in.arrayNext()) {
          for ( ; size1 != 0; size1--) {
            Selection_selection e1 = (ga1 != null ? ga1.peek() : null);
            if (e1 == null) {
              e1 = new Selection_selection();
            }
            e1.customDecode(in);
            a1.add(e1);
          }
