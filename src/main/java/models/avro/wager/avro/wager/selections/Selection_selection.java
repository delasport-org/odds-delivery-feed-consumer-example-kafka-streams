...
public class Selection_selection extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Selection_selection(Long id, CharSequence status, Selection_selection_eventInfo eventInfo, Selection_selection_lineInfo lineInfo, Selection_selection_odd odd) {
    this.id = id;
    this.status = status;
  ...
  public void put(int field$, Object value$) {
    ...
    case 2: eventInfo = (Selection_selection_eventInfo)value$; break;
    case 3: lineInfo = (Selection_selection_lineInfo)value$; break;
    case 4: odd = (Selection_selection_odd)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public Selection_selection_eventInfo getEventInfo() {
    return eventInfo;
  }
   ...
   * @param value the value to set.
   */
  public void setEventInfo(Selection_selection_eventInfo value) {
   ...
   */
  public Selection_selection_lineInfo getLineInfo() {
    return lineInfo;
  }
   ...
   * @param value the value to set.
   */
  public void setLineInfo(Selection_selection_lineInfo value) {
    this.lineInfo = value;
  }
   ...
   */
  public Selection_selection_odd getOdd() {
    return odd;
  }
   ...
   * @param value the value to set.
   */
  public void setOdd(Selection_selection_odd value) {
    this.odd = value;
  }
   ...
   */
  public static Selection_selection.Builder newBuilder() {
    return new Selection_selection.Builder();
  }
   ...
   * @return A new Selection_selection RecordBuilder
   */
  public static Selection_selection.Builder newBuilder(Selection_selection.Builder other) {
    if (other == null) {
      return new Selection_selection.Builder();
    } else {
      return new Selection_selection.Builder(other);
    }
  }
   ...
   * @return A new Selection_selection RecordBuilder
   */
  public static Selection_selection.Builder newBuilder(Selection_selection other) {
    if (other == null) {
      return new Selection_selection.Builder();
    } else {
      return new Selection_selection.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Selection_selection>
    ...
    private CharSequence status;
    private Selection_selection_eventInfo eventInfo;
    private Selection_selection_eventInfo.Builder eventInfoBuilder;
    private Selection_selection_lineInfo lineInfo;
    private Selection_selection_lineInfo.Builder lineInfoBuilder;
    private Selection_selection_odd odd;
    private Selection_selection_odd.Builder oddBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Selection_selection.Builder other) {
      super(other);
      ...
      if (other.hasEventInfoBuilder()) {
        this.eventInfoBuilder = Selection_selection_eventInfo.newBuilder(other.getEventInfoBuilder());
      }
      ...
      if (other.hasLineInfoBuilder()) {
        this.lineInfoBuilder = Selection_selection_lineInfo.newBuilder(other.getLineInfoBuilder());
      }
      ...
      if (other.hasOddBuilder()) {
        this.oddBuilder = Selection_selection_odd.newBuilder(other.getOddBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Selection_selection other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection.Builder setId(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection.Builder setStatus(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection.Builder setEventInfo(Selection_selection_eventInfo value) {
     ...
     * @return This builder.
     */
    public Selection_selection_eventInfo.Builder getEventInfoBuilder() {
      if (eventInfoBuilder == null) {
        if (hasEventInfo()) {
          setEventInfoBuilder(Selection_selection_eventInfo.newBuilder(eventInfo));
        } else {
          setEventInfoBuilder(Selection_selection_eventInfo.newBuilder());
        }
      }
    ...
    public Selection_selection.Builder setEventInfoBuilder(Selection_selection_eventInfo.Builder value) {
      clearEventInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection.Builder clearEventInfo() {
      eventInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection.Builder setLineInfo(Selection_selection_lineInfo value) {
     ...
     * @return This builder.
     */
    public Selection_selection_lineInfo.Builder getLineInfoBuilder() {
      if (lineInfoBuilder == null) {
        if (hasLineInfo()) {
          setLineInfoBuilder(Selection_selection_lineInfo.newBuilder(lineInfo));
        } else {
          setLineInfoBuilder(Selection_selection_lineInfo.newBuilder());
        }
      }
    ...
    public Selection_selection.Builder setLineInfoBuilder(Selection_selection_lineInfo.Builder value) {
      clearLineInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection.Builder clearLineInfo() {
      lineInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection.Builder setOdd(Selection_selection_odd value) {
     ...
     * @return This builder.
     */
    public Selection_selection_odd.Builder getOddBuilder() {
      if (oddBuilder == null) {
        if (hasOdd()) {
          setOddBuilder(Selection_selection_odd.newBuilder(odd));
        } else {
          setOddBuilder(Selection_selection_odd.newBuilder());
        }
      }
      return oddBuilder;
    }
    ...
    public Selection_selection.Builder setOddBuilder(Selection_selection_odd.Builder value) {
      clearOdd();
      oddBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Selection_selection.Builder clearOdd() {
      odd = null;
      oddBuilder = null;
    ...
    public Selection_selection build() {
      try {
        ...
        if (eventInfoBuilder != null) {
          ...
          record.eventInfo = fieldSetFlags()[2] ? this.eventInfo : (Selection_selection_eventInfo) defaultValue(fields()[2]);
        }
        if (lineInfoBuilder != null) {
          try {
          ...
          record.lineInfo = fieldSetFlags()[3] ? this.lineInfo : (Selection_selection_lineInfo) defaultValue(fields()[3]);
        }
        if (oddBuilder != null) {
          try {
          ...
          record.odd = fieldSetFlags()[4] ? this.odd : (Selection_selection_odd) defaultValue(fields()[4]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.eventInfo == null) {
          this.eventInfo = new Selection_selection_eventInfo();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.lineInfo == null) {
          this.lineInfo = new Selection_selection_lineInfo();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.odd == null) {
          this.odd = new Selection_selection_odd();
        }
