...
public class Wager_stake_wallet_compartment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Wager_stake_wallet_compartment(Wager_stake_wallet_compartment_real real, Wager_stake_wallet_compartment_virtual virtual) {
    this.real = real;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: real = (Wager_stake_wallet_compartment_real)value$; break;
    case 1: virtual = (Wager_stake_wallet_compartment_virtual)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public Wager_stake_wallet_compartment_real getReal() {
    return real;
  }
   ...
   */
  public void setReal(Wager_stake_wallet_compartment_real value) {
    this.real = value;
  }
   ...
   */
  public Wager_stake_wallet_compartment_virtual getVirtual() {
    return virtual;
  }
   ...
   * @param value the value to set.
   */
  public void setVirtual(Wager_stake_wallet_compartment_virtual value) {
    this.virtual = value;
  }
   ...
   */
  public static Wager_stake_wallet_compartment.Builder newBuilder() {
    return new Wager_stake_wallet_compartment.Builder();
  }
   ...
   * @return A new Wager_stake_wallet_compartment RecordBuilder
   */
  public static Wager_stake_wallet_compartment.Builder newBuilder(Wager_stake_wallet_compartment.Builder other) {
    if (other == null) {
      return new Wager_stake_wallet_compartment.Builder();
    } else {
      return new Wager_stake_wallet_compartment.Builder(other);
    }
  }
   ...
   * @return A new Wager_stake_wallet_compartment RecordBuilder
   */
  public static Wager_stake_wallet_compartment.Builder newBuilder(Wager_stake_wallet_compartment other) {
    if (other == null) {
      return new Wager_stake_wallet_compartment.Builder();
    } else {
      return new Wager_stake_wallet_compartment.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Wager_stake_wallet_compartment>
    ...
    private Wager_stake_wallet_compartment_real real;
    private Wager_stake_wallet_compartment_real.Builder realBuilder;
    private Wager_stake_wallet_compartment_virtual virtual;
    private Wager_stake_wallet_compartment_virtual.Builder virtualBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Wager_stake_wallet_compartment.Builder other) {
      super(other);
      ...
      if (other.hasRealBuilder()) {
        this.realBuilder = Wager_stake_wallet_compartment_real.newBuilder(other.getRealBuilder());
      }
      ...
      if (other.hasVirtualBuilder()) {
        this.virtualBuilder = Wager_stake_wallet_compartment_virtual.newBuilder(other.getVirtualBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Wager_stake_wallet_compartment other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.real)) {
        this.real = data().deepCopy(fields()[0].schema(), other.real);
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager_stake_wallet_compartment.Builder setReal(Wager_stake_wallet_compartment_real value) {
     ...
     * @return This builder.
     */
    public Wager_stake_wallet_compartment_real.Builder getRealBuilder() {
      if (realBuilder == null) {
        if (hasReal()) {
          setRealBuilder(Wager_stake_wallet_compartment_real.newBuilder(real));
        } else {
          setRealBuilder(Wager_stake_wallet_compartment_real.newBuilder());
        }
      }
      return realBuilder;
    }
    ...
    public Wager_stake_wallet_compartment.Builder setRealBuilder(Wager_stake_wallet_compartment_real.Builder value) {
      clearReal();
      realBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager_stake_wallet_compartment.Builder clearReal() {
      real = null;
      realBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager_stake_wallet_compartment.Builder setVirtual(Wager_stake_wallet_compartment_virtual value) {
     ...
     * @return This builder.
     */
    public Wager_stake_wallet_compartment_virtual.Builder getVirtualBuilder() {
      if (virtualBuilder == null) {
        if (hasVirtual()) {
          setVirtualBuilder(Wager_stake_wallet_compartment_virtual.newBuilder(virtual));
        } else {
          setVirtualBuilder(Wager_stake_wallet_compartment_virtual.newBuilder());
        }
      }
    ...
    public Wager_stake_wallet_compartment.Builder setVirtualBuilder(Wager_stake_wallet_compartment_virtual.Builder value) {
      clearVirtual();
    ...
    /**
      ...
      * @return This builder.
      */
    public Wager_stake_wallet_compartment.Builder clearVirtual() {
      virtual = null;
      virtualBuilder = null;
    ...
    public Wager_stake_wallet_compartment build() {
      try {
        ...
        if (realBuilder != null) {
          ...
          record.real = fieldSetFlags()[0] ? this.real : (Wager_stake_wallet_compartment_real) defaultValue(fields()[0]);
        }
        if (virtualBuilder != null) {
          try {
          ...
          record.virtual = fieldSetFlags()[1] ? this.virtual : (Wager_stake_wallet_compartment_virtual) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.real == null) {
          this.real = new Wager_stake_wallet_compartment_real();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.virtual == null) {
          this.virtual = new Wager_stake_wallet_compartment_virtual();
        }
